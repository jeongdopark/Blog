    ...
    <>
      <div
        ...
        style={{
          ...
          backgroundImage: [
            'linear-gradient(0, hsla(0, 84%, 24%, 0.4), transparent 50%)',
            'linear-gradient(to left top, hsla(0, 10%, 15%, 0.9), transparent 50%)',
            'radial-gradient(circle at 100% 100%, hsla(0, 20%, 30%, 1), hsla(0, 30%, 30%, 1) 17%, hsla(0, 30%, 30%, 0.6) 30%, transparent)',
          ].join(', '),
